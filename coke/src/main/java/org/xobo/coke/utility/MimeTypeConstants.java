...
/**
 * Known mime types. Originally copied from HandlerContext.java taken from Jetty 3.0.4 now updated
 * from mime.properties from Jetty 5.1.10.
 * 
...
public final class MimeTypeConstants {
  ...
  public static String getMimeTypeByFilename(String filename) {
    ...
    return extension == null ? null : getMimeType(extension);
  }
